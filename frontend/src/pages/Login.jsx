      ...
      <div className="w-full max-w-md">
        <div className="relative">
          <Card className="w-full border-none shadow-lg pt-10">
            {/* Lock icon wrapper with fixed positioning relative to the card */}
            ...
            <CardContent>
              <form onSubmit={handleLogin} className="space-y-3 sm:space-y-4">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <button 
                      ...
                      className="text-xs sm:text-sm text-indigo-600 hover:text-indigo-800 hover:underline font-medium"
                    >
                      Forgot password?
                    </button>
                  </div>
                ...
                <div className="flex items-center justify-between mt-1 sm:mt-2">
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-3 w-3 sm:h-4 sm:w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded cursor-pointer"
                    />
                ...
                <button
                  ...
                  className="w-full bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 flex items-center justify-center h-10 sm:h-11 text-sm sm:text-base mt-2 sm:mt-3"
                >
            ...
            <CardFooter className="flex flex-col space-y-3 sm:space-y-4 pb-4 sm:pb-6">
              <div className="relative flex items-center w-full">
                ...
                <span className="flex-shrink mx-2 sm:mx-4 text-gray-600 text-xs sm:text-sm">Don&apos;t have an account?</span>
                <div className="flex-grow border-t border-gray-300"></div>
              </div>
