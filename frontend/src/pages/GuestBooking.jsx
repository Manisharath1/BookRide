...
const BookForGuestPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-6 border-t">
                    <Button 
                      ...
                      className="px-8 py-2 bg-customBlue transition-all shadow-lg"
                    >
                      {isSubmitting ? (
                        <>
      ...
      {/* Mobile sidebar */}
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 bg-customBlue bg-opacity-40 md:hidden" onClick={toggleSidebar}>
          <div 
